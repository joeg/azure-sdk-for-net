...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    public class CloudBlob : IListBlobItem
    {
        ...
        {
            this.CopyFromBlob(
                SourceBlobToUri(source),
                null /* polling interval */,
                null /* max time to wait */,
        ...
        /// The copy ID and copy status fields are fetched, and the rest of the copy state is cleared.
        /// </remarks>
        public void CopyFromBlob(CloudBlob source, AccessCondition sourceAccessCondition, AccessCondition destAccessCondition, BlobRequestOptions options)
        {
            this.CopyFromBlob(
                SourceBlobToUri(source),
                null /* polling interval */,
        ...
        /// </summary>
        /// <param name="source">The source blob.</param>
        /// <param name="pollingInterval">The amount of time to wait between attempts to poll for completion.
        ///     If <c>null</c>, a default polling policy will be used.
        ///     If specified, this must be a positive time.</param>
        /// <param name="maxTimeToWait">The maximum time to allow for the copy to complete.
        ///     If <see cref="TimeSpan.Zero"/>, the call will fail unless the copy completes immediately.
        ///     If <c>null</c>, a default maximum time will be used.</param>
        /// <param name="sourceAccessCondition">An object that represents the access conditions for the source blob. If null, no condition is used.</param>
        /// <param name="destAccessCondition">An object that represents the access conditions for the destination blob. If null, no condition is used.</param>
        /// <param name="options">An object that specifies any additional options for the request.</param>
        /// <remarks>
        ...
        /// The copy ID and copy status fields are fetched, and the rest of the copy state is cleared.
        /// </remarks>
        public void CopyFromBlob(Uri source)
        {
            this.CopyFromBlob(
                source,
                null /* polling interval */,
        ...
        /// <param name="state">A user-defined object that will be passed to the callback delegate.</param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation.</returns>
        public IAsyncResult BeginCopyFromBlob(Uri source, AsyncCallback callback, object state)
        {
            return this.BeginCopyFromBlob(
                source,
                null /* polling interval */,
            ...
            object state)
        {
            ...
            return TaskImplHelper.BeginImpl<Action>(
                (setResult) => this.CopyFromBlobImpl(
                    source,
                    pollingInterval,
                    maxTimeToWait,
                    sourceAccessCondition,
        ...
        {
            Action updateProperties = TaskImplHelper.EndImpl<Action>(asyncResult);
            updateProperties();
        }
        ...
        /// <summary>
        /// Waits for an ongoing blob copy operation to complete.
        /// </summary>
        /// <param name="copyId">A string identifying the copy operation.</param>
        /// <remarks>This method fetches the blob's attributes.</remarks>
        public void WaitForCopy(string copyId)
        {
            this.WaitForCopy(
                copyId,
                null /* polling interval */,
            ...
            BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImpl(
                () => this.WaitForCopyImpl(
                    copyId,
                    pollingInterval,
                    maxTimeToWait,
                    accessCondition,
                    fullModifiers,
                    this.UpdateAfterFetchAttributes));
        }

        /// <summary>
        /// Begins an asynchronous operation to wait for an ongoing blob copy operation to complete.
        /// </summary>
        /// <param name="copyId">A string identifying the copy operation.</param>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes.</param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate.</param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation.</returns>
        public IAsyncResult BeginWaitForCopy(string copyId, AsyncCallback callback, object state)
        {
            return this.BeginWaitForCopy(
                copyId,
                null /* polling interval */,
                null /* max time to wait */,
                null /* access condition */,
        ...
        /// <param name="state">A user-defined object that will be passed to the callback delegate.</param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation.</returns>
        public IAsyncResult BeginWaitForCopy(
            string copyId,
            TimeSpan? pollingInterval,
            TimeSpan? maxTimeToWait,
            AccessCondition accessCondition,
            ...
            object state)
        {
            ...
            return TaskImplHelper.BeginImpl<BlobAttributes>(
                (setResult) => this.WaitForCopyImpl(
                    copyId,
                    pollingInterval,
                    maxTimeToWait,
                    accessCondition,
        ...
        /// <summary>
        /// Ends an asynchronous operation to wait for an ongoing blob copy operation to complete.
        /// </summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation.</param>
        /// <remarks>This method fetches the blob's attributes.</remarks>
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            ...
            "CA1822:MarkMembersAsStatic",
            Justification = "This is a member-operation")]
        public void EndWaitForCopy(IAsyncResult asyncResult)
        {
            BlobAttributes attributes = TaskImplHelper.EndImpl<BlobAttributes>(asyncResult);
